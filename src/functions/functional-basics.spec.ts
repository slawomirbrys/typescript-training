describe('Functional programming', function(){
	...
	it('maps a collection', function(){
		...
		function multiplyBy3(el: number): number {
			return el * 3;
		}
		function multiplyBy5(el: number): number {
			return el * 5;
		}
	...
	it('filters a collection', function(){
		...
		function isEven(el: number): boolean {
			return el % 2 == 0;
		}
	...
	it('reduces a collection to a single item', function(){
		...
		function sum(aggr: number, el: number): number {
			return aggr + el;
		}
	...
	it('sequentially processing via function pipe', function(){
		...
		function execute(fnSequence: Function[], init: number): number {
